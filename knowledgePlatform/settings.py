...
INSTALLED_APPS = [
    ...
    'knowledgePlatform.krole',
    'knowledgePlatform.kpermissions',
...
MIDDLEWARE = [
    ...
    'django.middleware.csrf.CsrfViewMiddleware',  # remove csrf limit
    'django.contrib.auth.middleware.AuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
    # 'knowledgePlatform.middleware.loginFilter.LoginFilter', # loginFilter
